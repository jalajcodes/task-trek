...
const AddUpdateForm = () => {
  ...
  console.log("🚀 ~ file: AddUpdateForm.js:48 ~ AddUpdateForm ~ entry:", entry);
  ...
  const { title, link, description, type, tags, status } = entry;
  ...
  return (
    <Paper>
      <form onSubmit={handleSubmit} className={classes.root}>
        ...
        {type === "todo" && (
          <div className={classes.radioInput} style={{ marginTop: 0 }}>
